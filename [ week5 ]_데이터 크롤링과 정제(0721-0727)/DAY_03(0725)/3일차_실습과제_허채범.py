...
# print(info[0].find_all('dd'))
# print(info[0].find_all('dd')[1].text.split()[1]) # 종목명
# print(info[0].find_all('dd')[8].text.split()[1])
...
#------------------------------------------------------------------------------
# # print(co_names[0])
# print(co_names[0].find('a'))
# print(co_names[0].find('a', {'class':'tltle'}))
# print()
# print(co_names[0].find('a').attrs)
# print(co_names[0].find('a', {'class':'tltle'}).attrs)
# print()
# print(co_names[0].find('a', {'class':'tltle'}).attrs['href'])
# print(co_names[0].find('a', {'href':'/item/main.naver?code=005930'}).attrs['class'])
# # print(co_names[0].find('a', {'href':'/item/main.naver?code=005930'}))
#------------------------------------------------------------------------------
